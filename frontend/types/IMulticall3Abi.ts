...
export interface IMulticall3AbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aggregate"
      | "aggregate3"
...
export interface IMulticall3Abi extends BaseContract {
  connect(runner?: ContractRunner | null): IMulticall3Abi;
  waitForDeployment(): Promise<this>;

  interface: IMulticall3AbiInterface;

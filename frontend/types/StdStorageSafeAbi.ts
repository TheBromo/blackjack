...
export interface StdStorageSafeAbiInterface extends Interface {
  getEvent(
...
export interface StdStorageSafeAbi extends BaseContract {
  connect(runner?: ContractRunner | null): StdStorageSafeAbi;
  waitForDeployment(): Promise<this>;

  interface: StdStorageSafeAbiInterface;

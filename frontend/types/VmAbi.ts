...
export interface VmAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "accessList"
      | "accesses"
...
export interface VmAbi extends BaseContract {
  connect(runner?: ContractRunner | null): VmAbi;
  waitForDeployment(): Promise<this>;

  interface: VmAbiInterface;

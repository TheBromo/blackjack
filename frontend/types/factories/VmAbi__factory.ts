...
import type { VmAbi, VmAbiInterface } from "../VmAbi";
...
export class VmAbi__factory {
  static readonly abi = _abi;
  static createInterface(): VmAbiInterface {
    return new Interface(_abi) as VmAbiInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): VmAbi {
    return new Contract(address, _abi, runner) as unknown as VmAbi;
  }
}

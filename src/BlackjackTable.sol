...
//     event CommitCreated(uint256 indexed rngId);
...
//
//         _createNewCommitteeRound(gameId);
//     }
//
//     // ============================================================
//     //  RNG COMMIT & DEAL
...
//         Game storage game = games[gameId];
//         require(RNG.isFinalized(game.rngRoundId), "Random committee must finish before continuing");
...
//         Game storage game = games[gameId];
//
//         uint256 seed = RNG.finalRandom(game.rngRoundId);
...
//                 //INFO: before each new card deal the rng has to be newly generated
//                 _createNewCommitteeRound(gameId);
//                 return;
//             }
...
//     }
//
//     function _createNewCommitteeRound(uint256 gameId) internal {
//         Game storage game = games[gameId];
//         uint256 rngId = RNG.createRound(getCommittee(gameId));
//         game.rngRoundId = rngId;
//     }
//
//     function getCommittee(uint256 gameId) internal view returns (address[] memory committee) {
//         Game storage game = games[gameId];
//         committee = new address[](game.players.length + 1);
//         for (uint256 i = 0; i < game.players.length; i++) {
//             committee[i] = game.players[i].addr;
//         }
//         committee[game.players.length] = TREASURY;
//     }
//
//     // ============================================================
//     //  HOUSE FUNCTIONS
